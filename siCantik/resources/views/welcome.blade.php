  ...
  <body>
    ...
    <section class="ftco-section bg-light">
      <div class="container">
        ...
        <section class="ftco-section ftco-discount img" style="background-image: url(pretty-gh-pages/images/bg_2.jpg);">
            <div class="overlay"></div>
            <div class="container">
    ...
    <section class="ftco-partner bg-light">
                ...
                <div class="col-md-10">
                    ...
                    <div class="col-md-3 ftco-animate">
                        <a href="#" class="partner-entry">
                            <img src="pretty-gh-pages/images/partner-1.jpg" class="img-fluid" alt="Colorlib template">
                        </a>
                    </div>
                    <div class="col-md-3 ftco-animate">
                        <a href="#" class="partner-entry">
                            <img src="pretty-gh-pages/images/partner-2.jpg" class="img-fluid" alt="Colorlib template">
                        </a>
                    </div>
                    <div class="col-md-3 ftco-animate">
                        <a href="#" class="partner-entry">
                            <img src="pretty-gh-pages/images/partner-3.jpg" class="img-fluid" alt="Colorlib template">
                        </a>
                    </div>
                    <div class="col-md-3 ftco-animate">
                        <a href="#" class="partner-entry">
                            <img src="pretty-gh-pages/images/partner-4.jpg" class="img-fluid" alt="Colorlib template">
                        </a>
                    </div>
                </div>
            </div>
        ...
        <section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url(pretty-gh-pages/images/bg_4.jpg);">
            <div class="overlay"></div>
      <div class="container">
        ...
        <div class="row d-flex">
          <div class="col-md-4 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              <a href="blog-single.html" class="block-20" style="background-image: url('pretty-gh-pages/images/image_1.jpg');">
              </a>
          ...
          <div class="col-md-4 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              <a href="blog-single.html" class="block-20" style="background-image: url('pretty-gh-pages/images/image_2.jpg');">
              </a>
              <div class="text py-4 d-block">
                <div class="meta">
                  <div><a href="#">Sept 10, 2018</a></div>
          ...
          <div class="col-md-4 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              <a href="blog-single.html" class="block-20" style="background-image: url('pretty-gh-pages/images/image_3.jpg');">
              </a>
              <div class="text py-4 d-block">
                <div class="meta">
                  <div><a href="#">Sept 10, 2018</a></div>
