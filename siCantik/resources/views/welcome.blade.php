        ...
        <div class="container">
            <div class="row justify-content-center mb-5 pb-3">
              <div class="col-md-7 heading-section text-center ftco-animate">
                <h2 class="mb-4">We care about your skin</h2>
                ...
                <div class="row">
                    <div class="col-md-3 ftco-animate">
                        <a href="#" class="partner-entry">
                            <img src="pretty-gh-pages/images/logo/emina.jpg" class="img-fluid" alt="emina">
                        </a>
                    </div>
                    <div class="col-md-3 ftco-animate">
                        <a href="#" class="partner-entry">
                            <img src="pretty-gh-pages/images/logo/sariayu.jpg" class="img-fluid" alt="sariayu">
                        </a>
                    </div>
                    <div class="col-md-3 ftco-animate">
                        <a href="#" class="partner-entry">
                            <img src="pretty-gh-pages/images/logo/logo-wardah.png" class="img-fluid" alt="wardah">
                        </a>
                    </div>
                    <div class="col-md-3 ftco-animate">
                        <a href="#" class="partner-entry">
                            <img src="pretty-gh-pages/images/logo/mustika-ratu.png" class="img-fluid" alt="mustika ratu">
                        </a>
                    </div>
                </div>
            </div>
