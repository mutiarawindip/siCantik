          ...
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
              <tr>
                ...
                <td>Emina</td>
                <td>23000</td>
                <td>A soft texture cleansing milk combined with Glycolic Acid helps to remove makeup and dirt gently without leaving oil residue and stripping skin moisture.</td>
              </tr>
            </tbody>
          </table>
        </div>
