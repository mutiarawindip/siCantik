   ...
   <!--  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    ...
    <!-- END nav -->
        ...
        <div class="row">
        	...
        	<div class="col-md-4 ftco-animate">
        		<a href="#" class="work-entry">
        			<img src="pretty-gh-pages/images/dry/wardah-5.jpg" class="img-fluid" alt="">
        			<div class="info d-flex align-items-center">
        				<div>
        					<div class="icon mb-4 d-flex align-items-center justify-content-center">
        						<span class="icon-search"></span>
        	...
        	<div class="col-md-4 ftco-animate">
        		<a href="#" class="work-entry">
        			<img src="pretty-gh-pages/images/normal/emina-4.jpg" class="img-fluid" alt="">
        			<div class="info d-flex align-items-center">
        				<div>
        					<div class="icon mb-4 d-flex align-items-center justify-content-center">
        						<span class="icon-search"></span>
        	...
        	<div class="col-md-4 ftco-animate">
        		<a href="#" class="work-entry">
        			<img src="pretty-gh-pages/images/dry/55819_B_V2.jpg" class="img-fluid" alt="">
        			<div class="info d-flex align-items-center">
        				<div>
        					<div class="icon mb-4 d-flex align-items-center justify-content-center">
        						<span class="icon-search"></span>
